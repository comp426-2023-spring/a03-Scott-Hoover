...
export function rpsls(inputchoice1){
	...
	const random_opponent = rpslsChoices[Math.floor(Math.random() * rpslsChoices.length)];
	if (inputchoice1 == random_opponent){
		return {
			"player": inputchoice1,
	...
	if ((inputchoice1 == "scissors" && random_opponent == "paper") ||
		(inputchoice1 == "paper" && random_opponent == "rock") ||
		(inputchoice1 == "rock" && random_opponent == "lizard") ||
		(inputchoice1 == "lizard" && random_opponent == "spock") ||
		(inputchoice1 == "spock" && random_opponent == "scissors") ||
		(inputchoice1 == "scissors" && random_opponent == "lizard") || 
		(inputchoice1 == "lizard" && random_opponent == "paper") ||
		(inputchoice1 == "paper" && random_opponent == "spock") || 
		(inputchoice1 == "spock" && random_opponent == "rock") ||
		(inputchoice1 == "rock" && random_opponent == "scissors")){
		return {
			"player": inputchoice1,
			"opponent": random_choice,
			"result": "win"
