...
export function rpsls(inputchoice){
	...
	} else if (inputchoice == "scissors" && random_opponent == "paper" ||
		inputchoice == "paper" && random_opponent == "rock" ||
		inputchoice == "rock" && random_opponent == "lizard" ||
		inputchoice == "lizard" && random_opponent == "spock" ||
		inputchoice == "spock" && random_opponent == "scissors" ||
		inputchoice == "scissors" && random_opponent == "lizard" || 
		inputchoice == "lizard" && random_opponent == "paper" ||
		inputchoice == "paper" && random_opponent == "spock" || 
		inputchoice == "spock" && random_opponent == "rock" ||
		inputchoice == "rock" && random_opponent == "scissors"){
		return {
			"player": inputchoice,
			"opponent": random_choice,
